                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="qty-control position-relative">
                                            ...
                                            <input type="number" value="{{ $item->qty }}" min="1" class="qty-control__number text-center">
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('cart.item.remove', ['rowId' => $item->rowId]) }}">
                                            @csrf @method('DELETE')
                                            <a href="javascript:void(0)" class="remove-cart">X</a>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
                                ...
                                <tbody>
                                    ...
                                    @if(Session::has('coupon'))
                                        ...
                                        <tr>
                                            ...
                                            <td>${{ Cart::instance('cart')->subtotal() - Session::get('coupon')['discount'] }}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <th>Shipping</th>
